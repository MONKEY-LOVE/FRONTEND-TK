...
export default function Sidebar(){
  const { user } = useAuth();
  return (
<aside class="flex flex-col w-80 h-screen px-6 py-7 overflow-y-auto bg-indigo-950 border-r rtl:border-r-0 rtl:border-l">
      <div class="flex flex-col justify-between flex-1 mt-6">
        <nav className='h-full flex flex-col shadow-sm'>
        <a class="flex items-center px-4 py-2 mt-5" href="#">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                </svg>

                <span class="mx-5 font-mono text-lg">Inicio</span>
            </a>
            <a class="flex items-center px-4 py-2 mt-5" href="#">
                ...
                <span class="mx-5 font-mono ">Canjear Tokens</span>
            </a>
            ...
            <a class="flex items-center px-4 py-2 mt-5" href="#">
                ...
                <span class="mx-5 font-mono">Crear Tokens</span>
            </a>
            ...
            <a class="flex items-center px-4 py-2 mt-5" href="#">
                ...
                <span class="mx-5 font-mono">Configuracion</span>
            </a>
        </nav>
        ...
        <div class="flex items-center justify-between mt-6">
                <a href="#" class="flex items-center gap-x-2">
                    ...
                    <span class="text-sm font-mono">{user.nombre} {user.apellido_pat} {user.apellido_mat}</span>
                </a>
